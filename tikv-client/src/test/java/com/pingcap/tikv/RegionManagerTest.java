...
public class RegionManagerTest extends PDMockServerTest {
  ...
  public void getStoreRegionCoveredRange() {
    ByteString startKey = ByteString.copyFrom(new byte[]{1});
    ByteString endKey = ByteString.copyFrom(new byte[]{10});
    KeyRange range = KeyRange.newBuilder().setStart(ByteString.copyFrom(new byte[]{5}))
        .setEnd(ByteString.copyFrom(new byte[7])).build();
    String testAddress = "testAddress";
    long storeId = 233;
    int confVer = 1026;
    int ver = 1027;
  ...
  public void getStoreRegionWithMultiRegionInRange() {
    ...
    int ver = 1027;
    long regionId = 233;
    KeyRange range = KeyRange.newBuilder().setStart(ByteString.copyFrom(new byte[]{1}))
        .setEnd(ByteString.copyFrom(new byte[10])).build();
    ...
    Metapb.Region region0 = GrpcUtils.makeRegion(
        regionId0,
    ...
    Metapb.Region region1 = GrpcUtils.makeRegion(
        regionId1,
    ...
    Metapb.Region region2 = GrpcUtils.makeRegion(
        regionId2,
    ...
    Metapb.Region region3 = GrpcUtils.makeRegion(
        regionId3,
    ...
    Metapb.Region region4 = GrpcUtils.makeRegion(
        regionId4,
